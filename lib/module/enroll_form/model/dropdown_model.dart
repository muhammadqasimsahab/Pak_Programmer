...
//
//     final dropdownApi = dropdownApiFromJson(jsonString);

import 'package:meta/meta.dart';
import 'dart:convert';

List<DropdownApi> dropdownApiFromJson(String str) => List<DropdownApi>.from(json.decode(str).map((x) => DropdownApi.fromJson(x)));

String dropdownApiToJson(List<DropdownApi> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));
...
class DropdownApi {
    ...
    factory DropdownApi.fromJson(Map<String, dynamic> json) => DropdownApi(
        id: json["id"],
        brand: json["brand"],
        name: json["name"],
        price: json["price"],
